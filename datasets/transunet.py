...
class TransUnetTrainDataset(Dataset):
...
class TransUnetTestDataset(Dataset):
...
class TransUnetDataLoader:
    def __init__(self, config):
        ...
        if config.data_mode == "imags":
            ...
            train_dataset = TransUnetTrainDataset(config.data_path, train_transforms_)
            test_dataset = TransUnetTestDataset(config.data_path, test_transforms_)
