...
class ResUnetTrainDataset(Dataset):
...
class ResUnetTestDataset(Dataset):
...
class ResUnetDataLoader:
    def __init__(self, config):
        ...
        if config.data_mode == "imags":
            ...
            train_dataset = ResUnetTrainDataset(config.data_path, train_transforms_)
            test_dataset = ResUnetTestDataset(config.data_path, test_transforms_)
